    ...
    for(int tc=0;tc<tt;tc++)
    {
        ...
        while(m--)
        {
            ...
            if(type==2)
            {
                ...
                int l=0;
                int r=intime[node];
                cout<<sg.query(0,0,len-1,l,r).data<<endl;
            }
            else
            {
                int s,x;
                ...
                sg.update(0,0,len-1,outime[s],outime[s],-1*x);
            }
        }
